      ...
      <main className="flex min-h-screen flex-col bg-black text-white overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="space-y-4">
              <p className="text-lg md:text-xl text-gray-300">
                Together, we don't just imagine a fairer
                world we make it real.
              </p>
              <p className="text-lg md:text-xl text-gray-300">
                We accelerate care, bring faster
                diagnostics,
              </p>
              <p className="text-lg md:text-xl text-gray-300">
                and deliver life-saving solutions where only
                silence once remained.
              </p>
            </div>
            <div className="space-y-4">
              <p className="text-lg md:text-xl text-gray-300 italic">
                This isn't just a mission. It's a call for
                dignity.
              </p>
              <p className="text-lg md:text-xl text-gray-300 italic">
                A gesture of hope. A promise of life.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full px-4 md:px-8 py-16 text-center bg-gradient-to-b from-black to-gray-900">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-lg md:text-xl text-gray-300">
              We are revolutionizing the NFT world by
              creating the first collection with a real and
              measurable impact on global health. Each
              myNFT4.life token you purchase directly funds
